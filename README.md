...
&#x20;   "ApiKey": "YOUR\_FINNHUB\_API\_KEY",
...
Replace `YOUR\_FINNHUB\_API\_KEY` with your actual Finnhub API key. `appsettings.Local.json` is intended for local configuration and should not be committed to the repository.
